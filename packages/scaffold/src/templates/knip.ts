...
export function knipTemplate(packageVersion: string): string {
  return dedent`
    {
      "$schema": "https://unpkg.com/knip@${packageVersion}/schema-jsonc.json",
      "rules": {
        ...
        "binaries": "error",
        // unable to resolve references to this catalog entry
        "catalog": "warn",
        ...
        "enumMembers": "warn",
        // unable to find references to this namespace member
