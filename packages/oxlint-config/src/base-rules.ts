...
export const baseRules: DummyRuleMap = {
  ...
  'unicorn-js/class-reference-in-static-methods': 'warn',
  'unicorn-js/consistent-conditional-object-spread': 'warn',
  'unicorn-js/consistent-destructuring': 'warn',
  'unicorn-js/consistent-json-file-read': 'warn',
  'unicorn-js/consistent-template-literal-escape': 'warn',
  'unicorn-js/consistent-tuple-labels': 'warn',
  'unicorn-js/default-export-style': 'warn',
  'unicorn-js/no-array-concat-in-loop': 'warn',
  'unicorn-js/no-array-splice': 'warn',
  'unicorn-js/no-computed-property-existence-check': 'warn',
  'unicorn-js/no-confusing-array-splice': 'warn',
  'unicorn-js/no-duplicate-if-branches': 'warn',
  'unicorn-js/no-duplicate-loops': 'warn',
  'unicorn-js/no-duplicate-set-values': 'warn',
  'unicorn-js/no-for-loop': 'warn',
  'unicorn-js/no-incorrect-query-selector': 'warn',
  'unicorn-js/no-incorrect-template-string-interpolation': 'warn',
  'unicorn-js/no-late-current-target-access': 'warn',
  'unicorn-js/no-late-event-control': 'warn',
  'unicorn-js/no-loop-iterable-mutation': 'warn',
  'unicorn-js/no-mismatched-map-key': 'warn',
  'unicorn-js/no-non-function-verb-prefix': 'warn',
  'unicorn-js/no-object-methods-with-collections': 'warn',
  'unicorn-js/no-optional-chaining-on-undeclared-variable': 'warn',
  'unicorn-js/no-return-array-push': 'warn',
  'unicorn-js/no-selector-as-dom-name': 'warn',
  'unicorn-js/no-this-outside-of-class': 'warn',
  'unicorn-js/no-top-level-assignment-in-function': 'warn',
  'unicorn-js/no-uncalled-method': 'warn',
  'unicorn-js/no-undeclared-class-members': 'warn',
  'unicorn-js/no-unnecessary-array-flat-map': 'warn',
  'unicorn-js/no-unnecessary-boolean-comparison': 'warn',
  'unicorn-js/no-unnecessary-splice': 'warn',
  'unicorn-js/no-unsafe-property-key': 'warn',
  'unicorn-js/no-useless-else': 'warn',
  'unicorn-js/no-useless-iterator-to-array': 'warn',
  'unicorn-js/prefer-abort-signal-any': 'warn',
  'unicorn-js/prefer-abort-signal-timeout': 'warn',
  'unicorn-js/prefer-array-from-async': 'warn',
  'unicorn-js/prefer-array-iterable-methods': 'warn',
  'unicorn-js/prefer-array-slice': 'warn',
  'unicorn-js/prefer-continue': 'warn',
  'unicorn-js/prefer-dom-node-html-methods': 'warn',
  'unicorn-js/prefer-else-if': 'warn',
  'unicorn-js/prefer-export-from': 'warn',
  'unicorn-js/prefer-get-or-insert-computed': 'warn',
  'unicorn-js/prefer-group-by': 'warn',
  'unicorn-js/prefer-hoisting-branch-code': 'warn',
  'unicorn-js/prefer-includes-over-repeated-comparisons': 'warn',
  'unicorn-js/prefer-iterator-to-array': 'warn',
  'unicorn-js/prefer-location-assign': 'warn',
  'unicorn-js/prefer-number-is-safe-integer': 'warn',
  'unicorn-js/prefer-object-destructuring-defaults': 'warn',
  'unicorn-js/prefer-observer-apis': 'warn',
  'unicorn-js/prefer-private-class-fields': 'warn',
  'unicorn-js/prefer-promise-try': 'warn',
  'unicorn-js/prefer-scoped-selector': 'warn',
  'unicorn-js/prefer-set-methods': 'warn',
  'unicorn-js/prefer-simple-condition-first': 'warn',
  'unicorn-js/prefer-single-call': 'warn',
  'unicorn-js/prefer-single-object-destructuring': 'warn',
  'unicorn-js/prefer-smaller-scope': 'warn',
  'unicorn-js/prefer-switch': 'warn',
  'unicorn-js/prefer-then-catch': 'warn',
  'unicorn-js/prefer-type-literal-last': 'warn',
